...
Assessment scores are calculated based on respondent answers to questions and are presented using one of two chart types. Understanding how scores are calculated and displayed is critical for interpreting assessment results.
...
The key difference between scoring approaches is how the overall score is presented to you.
...
- **Percentage-Based Conversion**: Score reflects your performance as a percentage of total possible points
