...
![Create Assessments form](../assets/screenshots/getting-started/gs-create-assessment.png)
...
![Share Assessments Link card with anonymous and direct recipient links](../assets/screenshots/getting-started/gs-assessment-share.png)
